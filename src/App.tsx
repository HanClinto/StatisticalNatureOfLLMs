  ...
  return <main>
    ...
    <section className="explanations" id="explanations">
      <div className="explanations-heading">
        ...
        <p className="explanations-feedback">Have feedback or an idea for another experiment? <a href="https://github.com/HanClinto/StatisticalNatureOfLLMs/issues/new">Share it on GitHub.</a></p>
      </div>
