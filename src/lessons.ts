...
export const LESSONS: Lesson[] = [
  ...
  },
  {
    ...
    demo: {
      ...
      callout: 'A fair coin gives heads and tails equal physical chances. Here, lowercase “heads” gets 74.9% while lowercase “tails” gets 6.9%. The model did not flip or observe a coin; it predicted how this sentence was likely to continue.',
      steps: 0,
