  ...
  },
  {
    ...
    demo: {
      ...
      scenarios: [
        ...
        { label: 'sc path', target: 'tree-path', title: 'The “sc” path', callout: 'After we forced “sc” as the first token, the lab continued generating for 35 more tokens. Compare this continuation with the other three paths; only the forced first token differs.', paths: [{ tokens: [' sc'], steps: 35 }] },
        { label: 'excited path', target: 'tree-path', title: 'The “excited” path', callout: 'After we forced “excited” as the first token, the lab continued generating for 35 more tokens with the same seed and temperature. That early choice changed every prediction that followed.', paths: [{ tokens: [' excited'], steps: 35 }] },
        { label: 'happy path', target: 'tree-path', title: 'The “happy” path', callout: 'After we forced “happy” as the first token, the lab again continued generating for 35 more tokens with the same seed and temperature. Flip between the paths to compare where this context led.', paths: [{ tokens: [' happy'], steps: 35 }] },
